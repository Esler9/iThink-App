          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Formulario Imei: <?php echo $_GET['Imei']; ?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <form>
                ...
                <div class="card-footer">
                  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-danger">Rechazar</button>
                </div>
              </form>
              </div>
              <!-- /.card-body -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            <div class="modal-header">
              <h4 class="modal-title">Rechazar Liberacion</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <p>Realmente Desea recharzar la Liberacion del Imei: <?php echo $_GET['Imei'];?></p>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-outline-light" data-dismiss="modal">Cerrar</button>
               <button type="button" class="btn btn-outline-light">Rechazar</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
