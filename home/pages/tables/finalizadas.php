...
<head>
  ...
  <title>iThink | Finalizadas </title>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php $sql = "SELECT * from liberacion where Cod_estado BETWEEN $page and $pageend and cod_tienda in ($tiendas)";
                    ...
                    while ($row = mysqli_fetch_array($result)) {?>
                      ...
                      <button type="button" class="btn btn-app bg-info <?php echo $user_state;?>" data-toggle="modal" data-target="#redo-<?php echo $row["serie"];?>"><i class="fas fa-solid fa-redo-alt"></i></button>
                      </td>
                    </tr>
                     <?php }?>
                  </tbody>
  ...
  <?php
    ...
    <?php  }elseif($alert ==5){?>
           ...
           $(document).Toasts('create', {
            ...
            subtitle: 'Imei:<?php echo $imei; ?>',
            body: "La Liberacion ha sido Finalizada <br>Imei:<?php echo $imei; ?><br><br> <a href='rechazadas.php' class='btn btn-default' >Ir a rechazadas</a>"
          });
