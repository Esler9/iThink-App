      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-outline card-primary">
            ...
            <div class="card-body">
<?php
// Consultar tabla Usuarios con los atributos indicados
$sql_users = "SELECT Codigo, `User`, Cod_Empleado, Password, State, cod_tienda, email, email_active, id_group_user FROM `Usuarios` ORDER BY Codigo DESC";
...
while ($u = mysqli_fetch_assoc($res_users)) {
  ...
  // Mapear grupo a nombre y badge
  switch ((string)$id_group) {
    case '1': $group_name = 'Admin'; $group_badge = 'danger'; break;
    case '2': $group_name = 'Supervisor'; $group_badge = 'primary'; break;
    case '3': $group_name = 'Usuario'; $group_badge = 'info'; break;
    default: $group_name = $id_group ? 'Grupo '.$id_group : 'Sin grupo'; $group_badge = 'secondary';
  }
...
?>
                    <tr>
                      ...
                      <td><?php echo htmlspecialchars($cod_tienda); ?></td>
